            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center space-x-8">
                    <a href="{{ route('dashboard.index') }}">
                        <img src="{{ asset('islaKonek.png') }}" class="block h-12 w-auto" alt="Logo">
                    </a>
                </div>
                ...
                <div class="hidden sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('cawhagan')" :active="request()->routeIs('cawhagan')">
                        {{ __('Cawhagan') }}
                    </x-nav-link>
                </div>

                <div class="hidden sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('gilutungan')" :active="request()->routeIs('gilutungan')">
                        {{ __('Gilutungan') }}
                    </x-nav-link>
                </div> --}}

                <!-- Vertical HR -->
                {{-- <div class=" border-l border-indigo-400 h-12 my-auto"></div> --}}
